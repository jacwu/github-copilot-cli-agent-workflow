...
3. Call POST /repos/{owner}/{repo}/issues/{issue_number}/comments
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Add a comment to a GitHub issue using the REST API"
    )
...
def main() -> int:
    ...
    try:
        ...
        if exc.code == 401:
            ...
            print("Error: Invalid request. Comment body may be invalid or issue state does not allow comments", file=sys.stderr)
        else:
